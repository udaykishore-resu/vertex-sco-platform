// vertex-posless-adapter (formerly POSless Adapter) — store-tier Vertex service.
//
// Interfaces directly with core Vertex services for POS-less / thin-client deployments that do not integrate a legacy POS.
//
